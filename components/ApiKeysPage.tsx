...
/** موديلات الـ API المتاحة لمفاتيح المطورين — منفصلة عن موديل الشات العادي
 * (اللي بقى موحّد وواحد بس في واجهة الشات بعد إعادة التصميم). */
const AVAILABLE_MODELS: { id: ModelId; label: string; hint: string }[] = [
