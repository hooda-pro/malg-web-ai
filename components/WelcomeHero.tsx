  ...
  return (
    <div className="flex h-full flex-1 flex-col items-center justify-center px-5 py-10 text-center">
      ...
      <div className="mt-7 grid w-full max-w-md grid-cols-1 gap-2 sm:grid-cols-2">
        {QUICK_PROMPTS.map((p, i) => (
          <button
            ...
            className="animate-slideUp [animation-fill-mode:both] rounded-md border border-line bg-panel/60 px-3 py-2.5 text-right text-[12.5px] text-txt2 transition hover:border-green/40 hover:text-txt"
          >
            {p}
          </button>
        ))}
      ...
      <button
        ...
        style={{ animationDelay: `${240 + QUICK_PROMPTS.length * 70}ms` }}
